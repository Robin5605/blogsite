...
export default function About() {
  return (
    <div className="flex flex-col min-h-screen w-screen bg-nord-500">
        ...
        <div className="flex flex-col mx-auto my-16 text-black">
          ...
          <div className="text-center p-4 text-nord-100 md:w-1/2 lg:w-1/3 mx-auto space-y-4">
            <p>
              ...
              I spent most of my time at {' '}
                <a target={"_blank"} href={"https://www.pythondiscord.com/"} className="text-indigo-700">
                  Python Discord
                </a>
              {' '}, where we help people learn to code in the {' '}
              <a target={"_blank"} href={"https://www.python.org"} className="text-indigo-700">
                Python
              </a>
